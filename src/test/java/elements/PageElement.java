...
public class PageElement {
    ...
    public static final class Product {
        public static final By LabsBackpack = By.id("add-to-cart-sauce-labs-backpack");
    ...
    public static final class CheckOutInformation {
        ...
        private static final By ZipCode = By.xpath("//*[@data-test='postalCode']");
        private static final By ContinueBtn = By.xpath("//*[@data-test='continue']");
        private static final By CanCelBtn = By.xpath("//*[@data-test='cancel']");
    }

    public static final class CheckOutOverview {
        private static final By CanCelBtn = By.xpath("//*[@data-test='cancel']");
        private static final By FinishBtn = By.xpath("//*[@data-test='finish']");
    }

    public static final class CheckoutCompleted {
        private static final By SuccessMessage = By.xpath("//*[@data-test='complete-header']");
    }
}
